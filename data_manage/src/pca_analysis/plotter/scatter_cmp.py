...
if __name__ == '__main__':
    ...
    fig.add_trace(go.Scatter(
        x=list(map(lambda data: data.x, datas_cmp)),
        y=list(map(lambda data: data.y, datas_cmp)),
        # mode="markers+text",
        mode="markers",
        name="rustc-perf",
        # text=list(map(lambda data: data.label, datas_cmp)),
